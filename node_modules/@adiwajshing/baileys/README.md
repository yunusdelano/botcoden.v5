 ...
 **Read the docs [here](https://xdlyy404.github.io/Baileys)**
 **Join the Discord [here](https://discord.gg/WeJM5FP9GG)**

## Example

Do check out & run [example.ts](https://github.com/xdlyy404/Baileys/blob/master/Example/example.ts) to see an example usage of the library.
...
```
yarn add @xdlyy404/baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```
yarn add github:xdlyy404/baileys
```

Then import your code using:
``` ts 
// for multi-device
import makeWASocket from '@xdlyy404/baileys'
// for legacy web
import {makeWALegacySocket} from '@xdlyy404/baileys'
```
...
``` ts
import makeWASocket, { DisconnectReason } from '@xdlyy404/baileys'
...
``` ts
import makeWASocket, { BufferJSON, useMultiFileAuthState } from '@xdlyy404/baileys'
...
``` ts
import makeWASocket, { makeInMemoryStore } from '@xdlyy404/baileys'
...
import { AnyWASocket } from '@xdlyy404/baileys'
```
...
``` ts
import { MessageType, MessageOptions, Mimetype } from '@xdlyy404/baileys'
...
const templateButtons = [
    {index: 1, urlButton: {displayText: '⭐ Star Baileys on GitHub!', url: 'https://github.com/xdlyy404/Baileys'}},
...
``` ts
// send a link
const sentMsg  = await sock.sendMessage(id, { text: 'Hi, this was sent using https://github.com/xdlyy404/baileys' })
```
...
- **MiscGenerationOptions**: some extra info about the message. It can have the following __optional__ values:
    ...
    const info: MessageOptions = {
        ...
        mimetype: Mimetype.pdf, /* (for media messages) specify the type of media (optional for all media types except documents),
                                    import {Mimetype} from '@xdlyy404/baileys'
                                */
...
import { downloadMediaMessage } from '@xdlyy404/baileys'
